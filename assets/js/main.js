...
//        jQuery('#newsletterSignup').on('submit', function (e) {
//            e.preventDefault();
//            var $form = jQuery(this);
//
//            var emails = jQuery('#footer-mailchimp').val();
//            var reEmail = /^([\w-\.]+)@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.)|(([\w-]+\.)+))([a-zA-Z]{2,4}|[0-9]{1,3})(\]?)$/;
//            if (emails == "" || emails == " ") {
//                jQuery('#news_response').text('Please enter your email id');
//            } else if (emails.length > 100) {
//                jQuery('#news_response').text('Email cannot exceed 100 characters');
//            } else if (!reEmail.test(emails)) {
//                jQuery('#news_response').text('Invalid Email');
//            }
//            // update user interface
//            $form.find('#news_response').html('Adding email address...');
//            // Prepare query string and send AJAX request
//            jQuery.ajax({
//                url: 'login/newsletter',
//                data: 'ajax=true&email=' + escape($form.find('.mailchimp_email').val()),
//                success: function (msg) {
//                    $form.find('#news_response').html(msg);
//                }
//            });
//        });
