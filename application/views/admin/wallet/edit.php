        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    echo form_open_multipart('admin/wallet/edit/' . $id, $attributes);
                    ?>
                    <div class="box-body"> 
                        <div id="sucess" style="color:green;">
                            <?php
                            if ($this->session->flashdata('inserted'))
                                echo "Buy Response Updated Sucessfully";
                            ?>
...
//                        echo form_submit($submit);
                        ...
                        echo '<a href="' . base_url('admin/wallet') . '" class="btn btn-primary" />Back</a>';
                        ?>
                    </div>
                    <?php
                    echo form_close();
