...
<!--                    <h3 class="box-title">Make Account</h3>-->
                ...
                <form class="popupAdd" id="popupBuyMoney">
                    <div class="form-group" style="width:100%">
                        ...
                        <input type="text" name="wallet" id="popupbuyingamount" value="<?php echo $row->useraddress; ?>" class="form-control" readonly="readonly" style="width:100%">
                        <span class="grey" style="color:red;" id="errAmount"></span>
                    </div>
                    <div class="form-group" style="width:100%">
                        <label for="buy">Amount:</label>
                        <input type="text" name="amount" id="popupbuyingamount" value="<?php echo $row->coin; ?>" class="form-control" readonly="readonly" style="width:100%">
                        <span class="grey" style="color:red;" id="errAmount"></span>
                    </div>
                    <div class="form-group" style="width:100%">
...
<script type="text/javascript">
    $(document).ready(function () {
        $('form#popupBuyMoney').submit(function (event) {
            ...
            var burl = '<?php echo base_url('admin/wallet/statusView'); ?>';
                $.ajax({
                    type: "POST",
                    url: burl,
                    contentType: false,
                    ...
                    success: function (response) {
                        if (response == '2') {
                            $("#errTxn").text('');
                            $('#suceesLevelAcc').html('Buy Wallet Updated Successfully.');
                            setTimeout(function() {
