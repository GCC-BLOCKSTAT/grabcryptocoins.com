...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>User Withdraw Response Detail</h1>
        <ol class="breadcrumb">
                                ...
                                if ($data) {
                                    foreach ($data as $row) {
                                        ...
                                        <tr>
                                            ...
                                            <td style="width:10%;"><?php echo $row->fname.' '.$row->mname.' '.$row->lname; ?></td>
                                            <td style="width:10%;"><?php echo $row->amount; ?></td>
                                            <td style="width:10%;"><?php echo $row->withdrawl_method; ?></td>
                                            <td style="width:10%;"><?php echo $row->withtxn_id; ?></td>
                                            <?php if($row->with_created_date){
                                                date_default_timezone_set('Asia/Kolkata');
                                                    $created_date = date('d/m/Y h:i:s a', $row->with_created_date); 
                                                }else{ 
                                                    $created_date = '-------'; }
                                                  
                                                if($row->with_update_date){
                                                    date_default_timezone_set('Asia/Kolkata');
                                                    $update_date = date('d/m/Y h:i:s a', $row->with_update_date); 
                                                }else{ 
                                                    $update_date = '-------'; }
                                                    ?>
                                            <td style="width:12%;"><?php echo $created_date; ?></td>
                                            <td style="width:12%;"><?php echo $update_date; ?></td>
                                            <td style="width:10%;"><?php if($row->withdrawlstatus == '1'){ echo 'Success'; }else if($row->withdrawlstatus == '2'){echo 'Cancelled';}else{ echo 'Pending'; } ?></td>
                                            <td style="width:20%;">
                                                <?php if ($row->withdrawlstatus == 0) { ?>
                                                   <a class="iframe" href="<?php echo base_url('admin/Withdraw/statusCheck/').$row->id.'/'.$row->withdrawlid; ?>">
                                                ...
                                                <?php } ?>
                                                    ...
                                                    <a class="iframe" href="<?php echo base_url(); ?>admin/withdraw/withdrawView/<?php echo $row->withdrawlid.'/'.$row->user_id; ?>">
