                ...
                <div class="box">
                    ...
                    <span id="sucess" style="color: #16e216;">
                        ...
                        if ($this->session->flashdata('inserted')) {
                            echo '<p style="margin-left:10px;font-size:18px;">Disclaimer Updated Sucessfully</p>';
                                ...
                                if ($data) {
                                    foreach ($data as $row) {
                                        ...
                                        <tr>
                                            ...
                                            <td style="width:20%;">  
                                                <a href="<?php echo base_url(); ?>admin/disclaimer/add/<?php echo $row->id; ?>"><img src="<?php echo base_url('assets/images/edit.png'); ?>" alt="Update page"  width="20" height="20" style="cursor: pointer;" title="Update Disclaimer"/></a>
                                            </td>
                                        </tr>
                                        <?php
                                        $i++;
