    ...
    <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
      <center>
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          ...
          <tr>
            <td class="free-text">
              Thank you for trading with GCC
              Your Sell wallet trasnsaction has been succcesfully completed.
              please check your wallet in my account section to view complete transcatiion details.
             </td>
          </tr>
          <tr>
            <td class="button">
