...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>User Sell Response Detail</h1>
        <ol class="breadcrumb">
                        ...
                        <table class="table table-bordered table-striped example1">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width:15%;">Coin Name</th>
                                ...
                                if ($data) {
                                    foreach ($data as $row) {
                                        ...
                                        <tr>
                                            ...
                                            <td style="width:15%;"><?php echo $row->buy_coin_name; ?></td>
                                            ...
                                            <td style="width:10%;">
                                                <a  href="<?php echo base_url('admin/Sellwallet/edit/').$row->id; ?>">
                                                    ...
                                                    <a class="iframe" href="<?php echo base_url(); ?>admin/sellwallet/sellerView/<?php echo $row->buyid .'/'.$row->user_id; ?>">
                                                    <img src="<?php echo base_url('assets/images/Eye.png'); ?>" alt="View Seller Details" width="20" height="20" style="cursor: pointer;" title="View Seller Details"/></a>
                                                    <?php if ($row->walletstatus == 0) { ?>
                                                   <a class="iframe" href="<?php echo base_url('admin/Sellwallet/statusCheck/').$row->id.'/'.$row->buyid; ?>">
                                    ...
                                    echo '<tr><td colspan=8 align=center><font color="red">No Data Found</font></td></tr>';
                                }
                                ?>
                            </tbody>
                        </table>
