          ...
          <tr>
            ...
            <![endif]-->
              <center style="background: white;">
                <table cellpadding="0" cellspacing="0" width="600" class="w320" style="min-height: 120px;">
                  <tr>
                    <td class="pull-left mobile-header-padding-left" style="vertical-align: middle;">
                      <a href="http://grabcryptocoins.com/"><img  height="80" src="http://grabcryptocoins.com/assets/img/logo-final.png" alt="logo"></a>
                    </td>
    ...
    <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
      <center>
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          ...
          <tr>
            <td class="free-text">
                <!--Thankyou for register with us. Please Check below button below to Verify Your Email.-->
                Thank You for registering with us. Please click the button bellow to verify your e-mail.
             </td>
          ...
          <tr>
            <td class="button">
              ...
              <![endif]--><a href="<?php echo $reset_link;?>"
                      ...
                      <tr>
                        <td class="mini-block-padding">
                          <table cellspacing="0" cellpadding="0" width="100%" style="border-collapse:separate !important;">
                            <tr>
                              <td>In case you face any issue please mark an e-mail to <a href="contact@grabcryptocoins.com">contact@grabcryptocoins.com</a></td>
                            </tr>
                          </table>
                        </td>
                      </tr>
...
<!--                    <table cellpadding="0" cellspacing="0" width="100%">
            ...
            <tr><td>In case you face any issue please mark an e-mail to <a href="contact@grabcryptocoins.com">contact@grabcryptocoins.com</a></td></tr>
        </table>
      </center>
    </td>
  </tr>
        ...
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          <tr>
            <td style="padding: 25px 0 25px">
              <strong>GCC BLOCKSTAT, DOBRINSKY DR </strong><br />
              WINNIPEG MANITOBA <br />
             CANADA - R2P 2N1<br /><br />
            </td>
          </tr>
        </table>
      </center>
